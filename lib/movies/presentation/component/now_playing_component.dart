    ...
    return BlocBuilder<MoviesBloc , MoviesState>(
      ...
      builder: (context , state){
        switch(state.nowPlayingState) {
              ...
              child: CarouselSlider(
                ...
                items: state.nowPlayingMovies.map(
                    ...
                    return GestureDetector(
                      ...
                      onTap: () {
                        Navigator.of(context).push( MaterialPageRoute(builder: (BuildContext context){return MovieDetailScreen(id: item.id,);} ) );
                      },
                      child: Stack(
                        children: [
                          ShaderMask(
          ...
          {
            return SizedBox(height: 400.0,child: Center(child: Text(state.nowPlayingMessage , style: TextStyle(color: Colors.red), )));
          }
          default:{
