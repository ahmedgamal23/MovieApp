      ...
      builder: (context , state){
        switch(state.moviesDetailsState) {
                      ...
                      background: FadeIn(
                        ...
                        child: ShaderMask(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: Constant.imageUrl(state.movieDetails!.backdropPath),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
          ...
          case RequestState.error:
            {
              return SizedBox(height: 400.0,child: Center(child: Text(state.moviesDetailsMessage , style: TextStyle(color: Colors.red), )));
            }
          default:{
            return SizedBox(height: 400.0,child: Center(child: Text(state.moviesDetailsMessage)));
          }
        }
    ...
    return BlocBuilder<MoviesDetailsBloc , MoviesDetailsState>(
      builder: (context , state){
        switch(state.recommendationState) {
          ...
          case RequestState.error:
            {
              return SizedBox(height: 400.0,child: Center(child: Text(state.recommendationMessage , style: TextStyle(color: Colors.red), )));
            }
          default:{
            return SizedBox(height: 400.0,child: Center(child: Text(state.recommendationMessage)));
          }
        }
      },
    );
